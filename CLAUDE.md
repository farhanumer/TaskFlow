...
This project uses the Linear project **"Claude Code Demo"** (team `FAR`, slug `e339ff79d213`) for issue tracking.

When asked about issues, tasks, or work items for this project, always check that Linear project first:
...
- **Entitlements File**: `Config/TaskFlow.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/TaskFlow.entitlements`:
